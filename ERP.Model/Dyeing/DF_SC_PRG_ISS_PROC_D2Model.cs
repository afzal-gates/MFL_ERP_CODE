...
namespace ERP.Model
{
    public class DF_SC_PRG_ISS_PROC_D2Model
    {
        ...
        public List<DF_SC_PRG_ISS_PROC_D3Model> scParamList { get; set; }

        public string Save()
        {
            const string sp = "SP_DF_SC_PRG_ISS_PROC_D2";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<DF_SC_PRG_ISS_PROC_D2Model> SelectAll()
        {
            string sp = "Select_DF_SC_PRG_ISS_PROC_D2";
            try
            {
                var obList = new List<DF_SC_PRG_ISS_PROC_D2Model>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SC_PRG_ISS_PROC_D2_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    DF_SC_PRG_ISS_PROC_D2Model ob = new DF_SC_PRG_ISS_PROC_D2Model();
        ...
        public List<DF_SC_PRG_ISS_PROC_D2Model> SelectByID(Int64? pDF_SC_PRG_ISS_H_ID = null, Int64? pDYE_BT_CARD_H_ID=null)
        {
            string sp = "PKG_DF_SC_PROGRAM.DF_SC_PRG_ISS_PROC_D2_Select";
            try
            {
                var obList = new List<DF_SC_PRG_ISS_PROC_D2Model>();
                OraDatabase db = new OraDatabase();
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    ob.scParamList = new DF_SC_PRG_ISS_PROC_D3Model().SelectByID(ob.DF_SC_PRG_ISS_PROC_D2_ID);
                    if (ob.scParamList.Count == 0)
                    {
                        if (ob.DF_PROC_TYPE_NAME.ToUpper().Contains("HEAT"))
                        {
                            ...
                            {
                                var obj = new DF_SC_PRG_ISS_PROC_D3Model();
        ...
        public DF_SC_PRG_ISS_PROC_D2Model Select(long ID)
        {
            string sp = "Select_DF_SC_PRG_ISS_PROC_D2";
            try
            {
                var ob = new DF_SC_PRG_ISS_PROC_D2Model();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SC_PRG_ISS_PROC_D2_ID", Value =0},
