...
namespace ERP.Model
{
    public class DYE_BT_STS_TYPEModel
    {
        ...
        public string Save()
        {
            const string sp = "SP_DYE_BT_STS_TYPE";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<DYE_BT_STS_TYPEModel> SelectAll()
        {
            string sp = "pkg_dye_batch_program.dye_bt_sts_type_select";
            try
            {
                var obList = new List<DYE_BT_STS_TYPEModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDYE_BT_STS_TYPE_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    DYE_BT_STS_TYPEModel ob = new DYE_BT_STS_TYPEModel();
        ...
        public DYE_BT_STS_TYPEModel Select(long ID)
        {
            string sp = "Select_DYE_BT_STS_TYPE";
            try
            {
                var ob = new DYE_BT_STS_TYPEModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDYE_BT_STS_TYPE_ID", Value =0},
