...
namespace ERP.Model
{
    public class DYE_CFG_SUB_STR_ITM_IAModel
    {
        public Int64 DYE_CFG_SUB_STR_ITM_IA_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "PKG_INVENTORY.DYE_CFG_SUB_STR_ITM_IA_INSERT";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pDYE_CFG_SUB_STR_ITM_IA_ID", Value = ob.DYE_CFG_SUB_STR_ITM_IA_ID},
        ...
        {
            const string sp = "PKG_INVENTORY.DYE_CFG_SUB_STR_ITM_IA_";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        {
            const string sp = "PKG_INVENTORY.DYE_CFG_SUB_STR_ITM_IA_DELETE";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<DYE_CFG_SUB_STR_ITM_IAModel> SelectByID(Int64? pSCM_STORE_ID=null)
        {
            string sp = "PKG_INVENTORY.DYE_CFG_SUB_STR_ITM_IA_SELECT";
            try
            {
                var obList = new List<DYE_CFG_SUB_STR_ITM_IAModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                ...
                {
                    DYE_CFG_SUB_STR_ITM_IAModel ob = new DYE_CFG_SUB_STR_ITM_IAModel();
                    ob.DYE_CFG_SUB_STR_ITM_IA_ID = (dr["DYE_CFG_SUB_STR_ITM_IA_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DYE_CFG_SUB_STR_ITM_IA_ID"]);
        ...
        public DYE_CFG_SUB_STR_ITM_IAModel Select(long ID)
        {
            string sp = "PKG_INVENTORY.DYE_CFG_SUB_STR_ITM_IA_SELECT";
            try
            {
                var ob = new DYE_CFG_SUB_STR_ITM_IAModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDYE_CFG_SUB_STR_ITM_IA_ID", Value =0},
