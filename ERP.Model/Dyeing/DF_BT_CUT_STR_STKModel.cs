...
namespace ERP.Model
{
    public class DF_BT_CUT_STR_STKModel
    {
        public Int64 DF_BT_CUT_STR_STK_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_DF_BT_CUT_STR_STK";
            string jsonStr="{";
            var ob = this;
            var i = 1;
            try
             {
                ...
                {
                     new CommandParameter() {ParameterName = "pDF_BT_CUT_STR_STK_ID", Value = ob.DF_BT_CUT_STR_STK_ID},
        ...
        public List<DF_BT_CUT_STR_STKModel> SelectAll()
        {
            string sp = "Select_DF_BT_CUT_STR_STK";
            try
            {
                var obList = new List<DF_BT_CUT_STR_STKModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_BT_CUT_STR_STK_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
              foreach (DataRow dr in ds.Tables[0].Rows)
               {
                            DF_BT_CUT_STR_STKModel ob = new DF_BT_CUT_STR_STKModel();
                            ob.DF_BT_CUT_STR_STK_ID = (dr["DF_BT_CUT_STR_STK_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DF_BT_CUT_STR_STK_ID"]);
        ...
        public DF_BT_CUT_STR_STKModel Select(long ID)
        {
            string sp = "Select_DF_BT_CUT_STR_STK";
            try
            {
                var ob = new DF_BT_CUT_STR_STKModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_BT_CUT_STR_STK_ID", Value =0},
