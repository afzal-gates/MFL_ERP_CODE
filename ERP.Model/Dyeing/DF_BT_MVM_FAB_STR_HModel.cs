...
namespace ERP.Model
{
    public class DF_BT_MVM_FAB_STR_HModel
    {
        ...
        public string Save()
        {
            const string sp = "SP_DF_BT_MVM_FAB_STR_H";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<DF_BT_MVM_FAB_STR_HModel> SelectAll()
        {
            string sp = "Select_DF_BT_MVM_FAB_STR_H";
            try
            {
                var obList = new List<DF_BT_MVM_FAB_STR_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_BT_MVM_FAB_STR_H_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    DF_BT_MVM_FAB_STR_HModel ob = new DF_BT_MVM_FAB_STR_HModel();
        ...
        public List<DF_BT_MVM_FAB_STR_HModel> SelectPendingLot2Rcv(Int64? pMC_BYR_ACC_GRP_ID = null, Int64? pMC_FAB_PROD_ORD_H_ID = null, Int64? pRF_FAB_PROD_CAT_ID = null, string pMONTHOF = null)
        {
            string sp = "PKG_DF_FIN_FAB.DF_BT_MVM_FAB_STR_H_Select";
            try
            {
                var obList = new List<DF_BT_MVM_FAB_STR_HModel>();
                OraDatabase db = new OraDatabase();
        ...
        public DF_BT_MVM_FAB_STR_HModel Select(long ID)
        {
            string sp = "Select_DF_BT_MVM_FAB_STR_H";
            try
            {
                var ob = new DF_BT_MVM_FAB_STR_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_BT_MVM_FAB_STR_H_ID", Value =0},
