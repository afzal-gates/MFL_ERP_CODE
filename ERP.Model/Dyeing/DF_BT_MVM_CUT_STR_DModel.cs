...
namespace ERP.Model
{
    public class DF_BT_MVM_CUT_STR_DModel
    {
        public Int64 DF_BT_MVM_CUT_STR_D_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_DF_BT_MVM_CUT_STR_D";
            string jsonStr="{";
            var ob = this;
            var i = 1;
            try
             {
                ...
                {
                     new CommandParameter() {ParameterName = "pDF_BT_MVM_CUT_STR_D_ID", Value = ob.DF_BT_MVM_CUT_STR_D_ID},
        ...
        public List<DF_BT_MVM_CUT_STR_DModel> SelectAll()
        {
            string sp = "Select_DF_BT_MVM_CUT_STR_D";
            try
            {
                var obList = new List<DF_BT_MVM_CUT_STR_DModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_BT_MVM_CUT_STR_D_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
              foreach (DataRow dr in ds.Tables[0].Rows)
               {
                            DF_BT_MVM_CUT_STR_DModel ob = new DF_BT_MVM_CUT_STR_DModel();
                            ob.DF_BT_MVM_CUT_STR_D_ID = (dr["DF_BT_MVM_CUT_STR_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DF_BT_MVM_CUT_STR_D_ID"]);
        ...
        public DF_BT_MVM_CUT_STR_DModel Select(long ID)
        {
            string sp = "Select_DF_BT_MVM_CUT_STR_D";
            try
            {
                var ob = new DF_BT_MVM_CUT_STR_DModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_BT_MVM_CUT_STR_D_ID", Value =0},
