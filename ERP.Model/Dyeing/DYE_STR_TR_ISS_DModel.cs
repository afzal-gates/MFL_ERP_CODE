...
namespace ERP.Model
{
    public class DYE_STR_TR_ISS_DModel
    {
        public Int64 DYE_STR_TR_ISS_D_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_DYE_STR_TR_ISS_D";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pDYE_STR_TR_ISS_D_ID", Value = ob.DYE_STR_TR_ISS_D_ID},
        ...
        public List<DYE_STR_TR_ISS_DModel> SelectAll()
        {
            string sp = "Select_DYE_STR_TR_ISS_D";
            try
            {
                var obList = new List<DYE_STR_TR_ISS_DModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDYE_STR_TR_ISS_D_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    DYE_STR_TR_ISS_DModel ob = new DYE_STR_TR_ISS_DModel();
                    ob.DYE_STR_TR_ISS_D_ID = (dr["DYE_STR_TR_ISS_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DYE_STR_TR_ISS_D_ID"]);
        ...
        public List<DYE_STR_TR_ISS_DModel> Select(Int64? pDYE_STR_TR_ISS_H_ID)
        {
            string sp = "pkg_dye_str_tf.dye_str_tr_iss_d_select";
            try
            {
                var obList = new List<DYE_STR_TR_ISS_DModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDYE_STR_TR_ISS_H_ID", Value =pDYE_STR_TR_ISS_H_ID},
