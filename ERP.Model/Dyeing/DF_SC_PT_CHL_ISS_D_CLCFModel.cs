...
namespace ERP.Model
{
    public class DF_SC_PT_CHL_ISS_D_CLCFModel
    {
        public Int64 DF_SC_PT_CHL_ISS_D_CLCF_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_DF_SC_PT_CHL_ISS_D_CLCF";
            string jsonStr="{";
            var ob = this;
            var i = 1;
            try
             {
                ...
                {
                     new CommandParameter() {ParameterName = "pDF_SC_PT_CHL_ISS_D_CLCF_ID", Value = ob.DF_SC_PT_CHL_ISS_D_CLCF_ID},
        ...
        public List<DF_SC_PT_CHL_ISS_D_CLCFModel> SelectAll()
        {
            string sp = "Select_DF_SC_PT_CHL_ISS_D_CLCF";
            try
            {
                var obList = new List<DF_SC_PT_CHL_ISS_D_CLCFModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SC_PT_CHL_ISS_D_CLCF_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
              foreach (DataRow dr in ds.Tables[0].Rows)
               {
                            DF_SC_PT_CHL_ISS_D_CLCFModel ob = new DF_SC_PT_CHL_ISS_D_CLCFModel();
                            ob.DF_SC_PT_CHL_ISS_D_CLCF_ID = (dr["DF_SC_PT_CHL_ISS_D_CLCF_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DF_SC_PT_CHL_ISS_D_CLCF_ID"]);
        ...
        public DF_SC_PT_CHL_ISS_D_CLCFModel Select(long ID)
        {
            string sp = "Select_DF_SC_PT_CHL_ISS_D_CLCF";
            try
            {
                var ob = new DF_SC_PT_CHL_ISS_D_CLCFModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SC_PT_CHL_ISS_D_CLCF_ID", Value =0},
