...
namespace ERP.Model
{
    public class DF_SC_PT_ISS_D1_TRMSModel
    {
        ...
        public string Save()
        {
            const string sp = "SP_DF_SC_PT_ISS_D1_TRMS";
            string jsonStr="{";
            var ob = this;
            var i = 1;
            try
             {
                ...
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     ...
                     new CommandParameter() {ParameterName = "pRQD_QTY_YDS", Value = ob.RQD_QTY_YDS},
                     new CommandParameter() {ParameterName = "pRQD_QTY_KG", Value = ob.RQD_QTY_KG},
        ...
        public List<DF_SC_PT_ISS_D1_TRMSModel> SelectByID(Int64? pDF_SC_PT_ISS_H_ID = null)
        {
            string sp = "PKG_DF_PT.DF_SC_PT_ISS_D1_TRMS_Select";
            try
            {
                var obList = new List<DF_SC_PT_ISS_D1_TRMSModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
              ...
              foreach (DataRow dr in ds.Tables[0].Rows)
               {
                            DF_SC_PT_ISS_D1_TRMSModel ob = new DF_SC_PT_ISS_D1_TRMSModel();
        ...
        public DF_SC_PT_ISS_D1_TRMSModel Select(long ID)
        {
            string sp = "Select_DF_SC_PT_ISS_D1_TRMS";
            try
            {
                var ob = new DF_SC_PT_ISS_D1_TRMSModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SC_PT_ISS_D1_TRMS_ID", Value =0},
