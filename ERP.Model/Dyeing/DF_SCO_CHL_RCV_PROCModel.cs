...
namespace ERP.Model
{
    public class DF_SCO_CHL_RCV_PROCModel
    {
        public Int64 DF_SCO_CHL_RCV_PROC_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_DF_SCO_CHL_RCV_PROC";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pDF_SCO_CHL_RCV_PROC_ID", Value = ob.DF_SCO_CHL_RCV_PROC_ID},
        ...
        public List<DF_SCO_CHL_RCV_PROCModel> SelectByID(Int64? pDF_SCO_CHL_RCV_H_ID = null, Int64? pDYE_BT_CARD_H_ID=null)
        {
            string sp = "PKG_DF_SC_PROGRAM.DF_SCO_CHL_RCV_PROC_SELECT";
            try
            {
                var obList = new List<DF_SCO_CHL_RCV_PROCModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                ...
                {
                    DF_SCO_CHL_RCV_PROCModel ob = new DF_SCO_CHL_RCV_PROCModel();
                    ob.DF_SCO_CHL_RCV_PROC_ID = (dr["DF_SCO_CHL_RCV_PROC_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DF_SCO_CHL_RCV_PROC_ID"]);
        ...
        public DF_SCO_CHL_RCV_PROCModel Select(long ID)
        {
            string sp = "DF_SCO_CHL_RCV_PROC_SELECT";
            try
            {
                var ob = new DF_SCO_CHL_RCV_PROCModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SCO_CHL_RCV_PROC_ID", Value =0},
