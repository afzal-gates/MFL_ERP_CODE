...
namespace ERP.Model
{
    public class DF_SCO_FSTR_RCV_D3Model
    {
        public Int64 DF_SCO_FSTR_RCV_D3_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_DF_SCO_FSTR_RCV_D3";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pDF_SCO_FSTR_RCV_D3_ID", Value = ob.DF_SCO_FSTR_RCV_D3_ID},
                     ...
                     new CommandParameter() {ParameterName = "pDYE_GSTR_BT_ISS_D3_ID", Value = ob.DYE_GSTR_BT_ISS_D3_ID},
        ...
        public List<DF_SCO_FSTR_RCV_D3Model> SelectAll(Int64? pDF_SCO_FSTR_RCV_H_ID = null)
        {
            string sp = "PKG_DF_RCV_FIN_FAB.DF_SCO_FSTR_RCV_D3_Select";
            try
            {
                var obList = new List<DF_SCO_FSTR_RCV_D3Model>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                ...
                {
                    DF_SCO_FSTR_RCV_D3Model ob = new DF_SCO_FSTR_RCV_D3Model();
                    ob.DF_SCO_FSTR_RCV_D3_ID = (dr["DF_SCO_FSTR_RCV_D3_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["DF_SCO_FSTR_RCV_D3_ID"]);
        ...
        public DF_SCO_FSTR_RCV_D3Model Select(long ID)
        {
            string sp = "Select_DF_SCO_FSTR_RCV_D3";
            try
            {
                var ob = new DF_SCO_FSTR_RCV_D3Model();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pDF_SCO_FSTR_RCV_D3_ID", Value =0},
        ...
        public List<DF_SCO_FSTR_RCV_D3Model> SelectForReceive(Int64? pSCM_SUPPLIER_ID = null)
        {
            string sp = "PKG_DF_RCV_FIN_FAB.dye_gstr_bt_iss_d3_select";
            try
            {
                List<DF_SCO_FSTR_RCV_D3Model> list = new List<DF_SCO_FSTR_RCV_D3Model>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
