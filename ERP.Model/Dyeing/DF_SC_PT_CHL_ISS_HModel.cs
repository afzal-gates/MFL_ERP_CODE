...
namespace ERP.Model
{
    public class DF_SC_PT_CHL_ISS_HModel
    {
        ...
        public string XML_ISU_D { get; set; }

        public string Save()
        {
            const string sp = "PKG_DF_PT.DF_SC_PT_CHL_ISS_H_INSERT";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     ...
                     new CommandParameter() {ParameterName = "pIS_ALT_PARTY", Value = ob.IS_ALT_PARTY},
                     new CommandParameter() {ParameterName = "pXML_ISU_D", Value = ob.XML_ISU_D},
        ...
        {
            const string sp = "SP_DF_SC_PT_CHL_ISS_H";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<DF_SC_PT_CHL_ISS_HModel> SelectAll(int pageNo, int pageSize, Int64? pSCM_SUPPLIER_ID = null, string pCHALAN_NO = null, string pCHALAN_DT = null, Int64? pUSER_ID = null)
        {
            string sp = "PKG_DF_PT.DF_SC_PT_CHL_ISS_H_SELECT";
            try
            {
                var obList = new List<DF_SC_PT_CHL_ISS_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     ...
                     new CommandParameter() {ParameterName = "pDF_SC_PT_CHL_ISS_H_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    DF_SC_PT_CHL_ISS_HModel ob = new DF_SC_PT_CHL_ISS_HModel();
        ...
        public List<DF_SC_PT_CHL_ISS_HModel> SelectBySupplierID(Int64? pSCM_SUPPLIER_ID = null, string pSC_PRG_NO = null)
        {
        ...
        public DF_SC_PT_CHL_ISS_HModel Select(Int64? pDF_SC_PT_CHL_ISS_H_ID = null)
        {
            string sp = "PKG_DF_PT.DF_SC_PT_CHL_ISS_H_SELECT";
            try
            {
                var ob = new DF_SC_PT_CHL_ISS_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
