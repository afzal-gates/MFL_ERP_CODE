...
namespace ERP.Model
{
    public class CM_EXP_LC_D_POModel
    {
        public Int64 CM_EXP_LC_D_PO_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_CM_EXP_LC_D_PO";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pCM_EXP_LC_D_PO_ID", Value = ob.CM_EXP_LC_D_PO_ID},
        ...
        public List<CM_EXP_LC_D_POModel> SelectAll()
        {
            string sp = "Select_CM_EXP_LC_D_PO";
            try
            {
                var obList = new List<CM_EXP_LC_D_POModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pCM_EXP_LC_D_PO_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    CM_EXP_LC_D_POModel ob = new CM_EXP_LC_D_POModel();
                    ob.CM_EXP_LC_D_PO_ID = (dr["CM_EXP_LC_D_PO_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["CM_EXP_LC_D_PO_ID"]);
        ...
        public List<CM_EXP_LC_D_POModel> SelectByID(Int64? pCM_EXP_LC_H_ID = null)
        {
            string sp = "Select_CM_EXP_LC_D_PO";
            try
            {
        ...
        public List<CM_EXP_LC_D_POModel> SelectByOrderID(Int64? pMC_ORDER_H_ID = null)
        {
            string sp = "PKG_CM_EXPORT_LC.ORDER_DETAILS_ORDERID_SELECT";
            try
            {
                var obList = new List<CM_EXP_LC_D_POModel>();
                OraDatabase db = new OraDatabase();
        ...
        public List<CM_EXP_LC_D_POModel> GetPOListByID(Int64? pCM_EXP_LC_H_ID = null)
        {
            string sp = "PKG_CM_EXPORT_LC.CM_EXP_LC_D_PO_SELECT";
            try
            {
                var obList = new List<CM_EXP_LC_D_POModel>();
                OraDatabase db = new OraDatabase();
        ...
        public CM_EXP_LC_D_POModel Select(long ID)
        {
            string sp = "Select_CM_EXP_LC_D_PO";
            try
            {
                var ob = new CM_EXP_LC_D_POModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pCM_EXP_LC_D_PO_ID", Value =0},
