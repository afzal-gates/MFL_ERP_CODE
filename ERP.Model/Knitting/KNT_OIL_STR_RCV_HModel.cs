...
namespace ERP.Model
{
    public class KNT_OIL_STR_RCV_HModel
    {
        public Int64 KNT_OIL_STR_RCV_H_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "PKG_KNT_RCV_MCN_OIL.KNT_OIL_STR_RCV_H_INSERT";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pKNT_OIL_STR_RCV_H_ID", Value = ob.KNT_OIL_STR_RCV_H_ID},
                     ...
                     new CommandParameter() {ParameterName = "opKNT_OIL_STR_RCV_H_ID", Value =0, Direction = ParameterDirection.Output}
                 }, sp);
        ...
        {
            const string sp = "SP_KNT_OIL_STR_RCV_H";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<KNT_OIL_STR_RCV_HModel> SelectAll(int pageNo, int pageSize, string pMRR_NO = null, string pMRR_DT = null, string pCOMP_NAME_EN = null, string pREQ_TYPE_NAME = null, string pPAY_MTHD_NAME = null, string pLOC_SRC_TYPE_NAME = null, string pREMARKS = null)
        {
            string sp = "PKG_KNT_RCV_MCN_OIL.KNT_OIL_STR_RCV_H_SELECT";
            try
            {
                var obList = new List<KNT_OIL_STR_RCV_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pKNT_OIL_STR_RCV_H_ID", Value =0},
                ...
                {
                    KNT_OIL_STR_RCV_HModel ob = new KNT_OIL_STR_RCV_HModel();
                    ob.KNT_OIL_STR_RCV_H_ID = (dr["KNT_OIL_STR_RCV_H_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_OIL_STR_RCV_H_ID"]);
        ...
        public KNT_OIL_STR_RCV_HModel Select(Int64? pKNT_OIL_STR_RCV_H_ID = null)
        {
            string sp = "PKG_KNT_RCV_MCN_OIL.KNT_OIL_STR_RCV_H_SELECT";
            try
            {
                var ob = new KNT_OIL_STR_RCV_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pKNT_OIL_STR_RCV_H_ID", Value =pKNT_OIL_STR_RCV_H_ID},
