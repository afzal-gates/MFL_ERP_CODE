...
namespace ERP.Model
{
    public class SCM_YRN_REQ_STATUSModel
    {
        public Int64 SCM_YRN_REQ_STATUS_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_SCM_YRN_REQ_STATUS";
            string jsonStr="{";
            var ob = this;
            var i = 1;
            try
             {
                ...
                {
                     new CommandParameter() {ParameterName = "pSCM_YRN_REQ_STATUS_ID", Value = ob.SCM_YRN_REQ_STATUS_ID},
        ...
        public List<SCM_YRN_REQ_STATUSModel> SelectAll()
        {
            string sp = "Select_SCM_YRN_REQ_STATUS";
            try
            {
                var obList = new List<SCM_YRN_REQ_STATUSModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pSCM_YRN_REQ_STATUS_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
              foreach (DataRow dr in ds.Tables[0].Rows)
               {
                            SCM_YRN_REQ_STATUSModel ob = new SCM_YRN_REQ_STATUSModel();
                            ob.SCM_YRN_REQ_STATUS_ID = (dr["SCM_YRN_REQ_STATUS_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["SCM_YRN_REQ_STATUS_ID"]);
        ...
        public SCM_YRN_REQ_STATUSModel Select(long ID)
        {
            string sp = "Select_SCM_YRN_REQ_STATUS";
            try
            {
                var ob = new SCM_YRN_REQ_STATUSModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pSCM_YRN_REQ_STATUS_ID", Value =0},
