...
namespace ERP.Model
{
    public class KNT_SCO_GFAB_RET_HModel
    {
        ...
        private List<KNT_SCO_GFAB_RET_DModel> _fabRtnDtl = null;
        public List<KNT_SCO_GFAB_RET_DModel> fabRtnDtl
        {
            get
            {
                if (_fabRtnDtl == null)
                {
                    _fabRtnDtl = new List<KNT_SCO_GFAB_RET_DModel>();
                }
                return _fabRtnDtl;
            }
            set
        ...
        public string BatchSave4ScoFabRtn()
        {
            const string sp = "pkg_knit_subcontract.knt_sco_chl_rtn_batch_save";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public KNT_SCO_GFAB_RET_HModel GetScoRtnChalnHdr(Int64 pKNT_SCO_GFAB_RET_H_ID)
        {
            string sp = "pkg_knit_subcontract.knt_sco_gfab_ret_h_select";
            try
            {
                var ob = new KNT_SCO_GFAB_RET_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    var obFabRtnList = new KNT_SCO_GFAB_RET_DModel().GetFabRtnList(pKNT_SCO_GFAB_RET_H_ID);
        ...
        public object GetScoRtnChallanList(int pageNumber, int pageSize, Int32? pSCM_SUPPLIER_ID = null, Int32? pSCM_STORE_ID = null,
            string pRET_CHALAN_NO = null, DateTime? pRET_CHALAN_DT = null, string pSTYLE_NO = null, string pORDER_NO_LST = null)
        {
            ...
            {
                Int64 vTotalRec = 0;
                var obList = new List<KNT_SCO_GFAB_RET_HModel>();
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    KNT_SCO_GFAB_RET_HModel ob = new KNT_SCO_GFAB_RET_HModel();
                    ob.KNT_SCO_GFAB_RET_H_ID = (dr["KNT_SCO_GFAB_RET_H_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_SCO_GFAB_RET_H_ID"]);
                    ob.SCM_STORE_ID = (dr["SCM_STORE_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["SCM_STORE_ID"]);
                    ob.SCM_SUPPLIER_ID = (dr["SCM_SUPPLIER_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["SCM_SUPPLIER_ID"]);
                    ob.RET_CHALAN_NO = (dr["RET_CHALAN_NO"] == DBNull.Value) ? string.Empty : Convert.ToString(dr["RET_CHALAN_NO"]);
