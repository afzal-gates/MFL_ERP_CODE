...
namespace ERP.Model
{
    public class KNT_SCI_GFAB_RET_DModel
    {
        public Int64 KNT_SCI_GFAB_RET_D_ID { get; set; }
        public Int64 KNT_SCI_GFAB_RET_H_ID { get; set; }
        public Int64 KNT_STYL_FAB_ITEM_ID { get; set; }
        public Int64? RET_ROLL_QTY { get; set; }
        ...
        public List<KNT_SCI_GFAB_RET_DModel> SelectAll()
        {
            string sp = "Select_KNT_SCI_GFAB_RET_D";
            try
            {
                var obList = new List<KNT_SCI_GFAB_RET_DModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pKNT_SCI_GFAB_RET_D_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    KNT_SCI_GFAB_RET_DModel ob = new KNT_SCI_GFAB_RET_DModel();
                    ob.KNT_SCI_GFAB_RET_D_ID = (dr["KNT_SCI_GFAB_RET_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_SCI_GFAB_RET_D_ID"]);
        ...
        public List<KNT_SCI_GFAB_RET_DModel> GetSciFabRtnList(long? pKNT_SCI_GFAB_RET_H_ID)
        {
            string sp = "pkg_knit_subcontract.knt_sci_gfab_ret_d_select";
            try
            {
                var obList = new List<KNT_SCI_GFAB_RET_DModel>();
                OraDatabase db = new OraDatabase();
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    ob.KNT_SCI_GFAB_RET_H_ID = (dr["KNT_SCI_GFAB_RET_H_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_SCI_GFAB_RET_H_ID"]);
                    ob.KNT_STYL_FAB_ITEM_ID = (dr["KNT_STYL_FAB_ITEM_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_STYL_FAB_ITEM_ID"]);
                    ob.RET_ROLL_QTY = (dr["RET_ROLL_QTY"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["RET_ROLL_QTY"]);
                    ob.RET_GFAB_QTY = (dr["RET_GFAB_QTY"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["RET_GFAB_QTY"]);
                    ob.QTY_MOU_ID = (dr["QTY_MOU_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["QTY_MOU_ID"]);
