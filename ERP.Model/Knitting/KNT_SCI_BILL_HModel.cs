...
namespace ERP.Model
{
    public class KNT_SCI_BILL_HModel
    {
        ...
        public string SCI_BILL_D_XML { get; set; }
        ...
        {
            const string sp = "pkg_knit_subcontract.knt_sci_bill_save";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     ...
                     new CommandParameter() {ParameterName = "pSCI_BILL_D_XML", Value = ob.SCI_BILL_D_XML},
        ...
        public object GetBillList(int pageNumber, int pageSize, Int64 pSCM_SUPPLIER_ID, string pBILL_NO = null, DateTime? pBILL_DT = null)
        {
            ...
            {
                Int64 vTotalRec = 0;
                var obList = new List<KNT_SCI_BILL_HModel>();
                ...
                {
                    KNT_SCI_BILL_HModel ob = new KNT_SCI_BILL_HModel();
        ...
        public KNT_SCI_BILL_HModel GetBillHdr(Int64 pKNT_SCI_BILL_H_ID)
        {
            string sp = "pkg_knit_subcontract.knt_sci_bill_h_select";
            try
            {
                var ob = new KNT_SCI_BILL_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
    ...
    public class KNT_SCI_BILL_USR_LAVELModel
    {
        public string USER_DRAFT_NAME { get; set; }
        public string USER_VERIFIER_NAME { get; set; }


        public KNT_SCI_BILL_USR_LAVELModel GetSciBillProcUserLavel()
        {
            string sp = "pkg_knit_subcontract.knt_sci_bill_h_select";
            try
            {
                var ob = new KNT_SCI_BILL_USR_LAVELModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {                     
                     new CommandParameter() {ParameterName = "pSC_USER_ID", Value = HttpContext.Current.Session["multiScUserId"]},
