...
namespace ERP.Model
{
    public class KNT_SCO_BILL_DModel
    {
        public Int64 KNT_SCO_BILL_D_ID { get; set; }
        ...
        public List<KNT_SCO_BILL_DModel> GetBillDtl(Int64 pKNT_SCO_BILL_H_ID)
        {
            string sp = "pkg_knit_subcontract.knt_sco_bill_h_select";
            try
            {
                var obList = new List<KNT_SCO_BILL_DModel>();
                ...
                {
                    KNT_SCO_BILL_DModel ob = new KNT_SCO_BILL_DModel();
                    ob.KNT_SCO_BILL_D_ID = (dr["KNT_SCO_BILL_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_SCO_BILL_D_ID"]);
        ...
        public KNT_SCO_BILL_DModel Select(long ID)
        {
            string sp = "Select_KNT_SCO_BILL_D";
            try
            {
                var ob = new KNT_SCO_BILL_DModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pKNT_SCO_BILL_D_ID", Value =0},
