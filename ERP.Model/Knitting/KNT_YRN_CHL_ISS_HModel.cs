...
namespace ERP.Model
{
    public class KNT_YRN_CHL_ISS_HModel
    {
        ...
        public string XML_CHL_D { get; set; }


        public string Save()
        {
            const string sp = "PKG_KNIT_YARN_ISSUE.KNT_YRN_CHL_ISS_H_INSERT";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     ...
                     new CommandParameter() {ParameterName = "pXML_CHL_D", Value = ob.XML_CHL_D},
        ...
        {
            const string sp = "SP_KNT_YRN_CHL_ISS_H";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<KNT_YRN_CHL_ISS_HModel> SelectAll(int pageNo, int pageSize, Int64? pSCM_SUPPLIER_ID = null, string pCHALAN_NO = null, string pCHALAN_DT = null, Int64? pUSER_ID = null)
        {
            string sp = "PKG_KNIT_YARN_ISSUE.KNT_YRN_CHL_ISS_H_SELECT";
            try
            {
                var obList = new List<KNT_YRN_CHL_ISS_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {                    
                     ...
                     new CommandParameter() {ParameterName = "pKNT_YRN_CHL_ISS_H_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    KNT_YRN_CHL_ISS_HModel ob = new KNT_YRN_CHL_ISS_HModel();
        ...
        public KNT_YRN_CHL_ISS_HModel Select(Int64? pKNT_YRN_CHL_ISS_H_ID = null)
        {
            string sp = "PKG_KNIT_YARN_ISSUE.KNT_YRN_CHL_ISS_H_SELECT";
            try
            {
                var ob = new KNT_YRN_CHL_ISS_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
