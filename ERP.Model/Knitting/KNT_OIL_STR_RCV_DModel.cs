...
namespace ERP.Model
{
    public class KNT_OIL_STR_RCV_DModel
    {
        public Int64 KNT_OIL_STR_RCV_D_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_KNT_OIL_STR_RCV_D";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pKNT_OIL_STR_RCV_D_ID", Value = ob.KNT_OIL_STR_RCV_D_ID},
        ...
        public List<KNT_OIL_STR_RCV_DModel> SelectAll()
        {
            string sp = "Select_KNT_OIL_STR_RCV_D";
            try
            {
                var obList = new List<KNT_OIL_STR_RCV_DModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pKNT_OIL_STR_RCV_D_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    KNT_OIL_STR_RCV_DModel ob = new KNT_OIL_STR_RCV_DModel();
                    ob.KNT_OIL_STR_RCV_D_ID = (dr["KNT_OIL_STR_RCV_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["KNT_OIL_STR_RCV_D_ID"]);
        ...
        public List<KNT_OIL_STR_RCV_DModel> SelectByID(Int64? pKNT_OIL_STR_RCV_H_ID = null)
        {
            string sp = "PKG_KNT_RCV_MCN_OIL.KNT_OIL_STR_RCV_D_SELECT";
            try
            {
                var obList = new List<KNT_OIL_STR_RCV_DModel>();
                OraDatabase db = new OraDatabase();
        ...
        public KNT_OIL_STR_RCV_DModel Select(long ID)
        {
            string sp = "PKG_KNT_RCV_MCN_OIL.KNT_OIL_STR_RCV_D_SELECT";
            try
            {
                var ob = new KNT_OIL_STR_RCV_DModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pKNT_OIL_STR_RCV_D_ID", Value =0},
