...
namespace ERP.Model
{
    public class GMT_FIN_IRON_HModel
    {
        public Int64? GMT_FIN_IRON_H_ID { get; set; }
        ...
        public string GMT_FIN_IRON_H_XML { get; set; }
        public string GMT_FIN_IRON_D_XML { get; set; }

        public List<ExpandoObject> itemsOrder { get; set; }


        private List<GMT_FIN_IRON_DModel> _itemsGmtFinIronDtl = null;
        public List<GMT_FIN_IRON_DModel> itemsGmtFinIronDtl
        {
            get
            {
                if (_itemsGmtFinIronDtl == null)
                {
                    _itemsGmtFinIronDtl = new List<GMT_FIN_IRON_DModel>();
                }
                return _itemsGmtFinIronDtl;
            }
            set
            {
                _itemsGmtFinIronDtl = value;
            }
        }
        ...
        public string BatchSaveGmtFinIron()
        {
            const string sp = "pkg_gmt_fin.gmt_fin_iron_save";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pGMT_FIN_IRON_H_XML", Value = ob.GMT_FIN_IRON_H_XML},
                     new CommandParameter() {ParameterName = "pGMT_FIN_IRON_D_XML", Value = ob.GMT_FIN_IRON_D_XML},
        ...
        public List<ExpandoObject> GetGmtFinOrderList(Int64? pGMT_FIN_IRON_H_ID, string pMC_ORDER_H_LST)
        {
            string sp = "pkg_gmt_fin.gmt_fin_iron_h_select";
            try
            {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    ...
                    foreach (DataRow dr1 in ds1.Tables[0].Rows)
                    {
                        ...
                        var ds2 = db.ExecuteStoredProcedure(new List<CommandParameter>()
                        {
                             ...
                             new CommandParameter() {ParameterName = "pGMT_FIN_IRON_H_ID", Value =pGMT_FIN_IRON_H_ID},
                        ...
                        foreach (DataRow dr2 in ds2.Tables[0].Rows)
                        {
                            ...
                            obOrdSize.GMT_FIN_IRON_D_ID = (dr2["GMT_FIN_IRON_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr2["GMT_FIN_IRON_D_ID"]);
                            ...
                            obOrdSize.GMT_FIN_IRON_H_ID = (dr2["GMT_FIN_IRON_H_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr2["GMT_FIN_IRON_H_ID"]);
                            ...
                            obOrdSize.IRON_QTY = (dr2["IRON_QTY"] == DBNull.Value) ? 0 : Convert.ToInt64(dr2["IRON_QTY"]);
        ...
        public List<GMT_FIN_IRON_HModel> GetGmtFinIronData(DateTime pCALENDAR_DT, string pHR_PROD_FLR_LST)
        {
            string sp = "pkg_gmt_fin.gmt_fin_iron_h_select";
            try
            {
                var obList = new List<GMT_FIN_IRON_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                ...
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    GMT_FIN_IRON_HModel ob = new GMT_FIN_IRON_HModel();

                    ob.GMT_FIN_IRON_H_ID = (dr["GMT_FIN_IRON_H_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["GMT_FIN_IRON_H_ID"]);
                    ...
                    ob.itemsOrder = ob.GetGmtFinOrderList(ob.GMT_FIN_IRON_H_ID, ob.MC_ORDER_H_LST);
    ...
    //public class GMT_FIN_IRON_ORDERModel
    //{
    //    public Int64 GMT_FIN_IRON_H_ID { get; set; }
    //    public Int64 HR_PROD_FLR_ID { get; set; }
    //    public Int64 GMT_PROD_PLN_CLNDR_ID { get; set; }
    ...
    //public class GMT_FIN_IRON_ORDER_ITEMModel
    //{
    //    public Int64 GMT_FIN_IRON_H_ID { get; set; }
    //    public Int64 HR_PROD_FLR_ID { get; set; }
    //    public Int64 GMT_PROD_PLN_CLNDR_ID { get; set; }
