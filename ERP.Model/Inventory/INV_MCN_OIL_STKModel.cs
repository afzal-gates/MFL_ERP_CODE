...
namespace ERP.Model
{
    public class INV_MCN_OIL_STKModel
    {
        public Int64 INV_MCN_OIL_STK_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_INV_MCN_OIL_STK";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pINV_MCN_OIL_STK_ID", Value = ob.INV_MCN_OIL_STK_ID},
        ...
        public List<INV_MCN_OIL_STKModel> SelectAll()
        {
            string sp = "PKG_KNT_MCN_OIL.INV_GEN_ITEM_STK_SELECT";
            try
            {
                var obList = new List<INV_MCN_OIL_STKModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                ...
                {
                    INV_MCN_OIL_STKModel ob = new INV_MCN_OIL_STKModel();
        ...
        public List<INV_MCN_OIL_STKModel> SelectByItem(Int64? pSCM_STORE_ID = null, Int64? pINV_ITEM_ID = null)
        {
            string sp = "PKG_KNT_MCN_OIL.INV_GEN_ITEM_STK_SELECT";
            try
            {
        ...
        public INV_MCN_OIL_STKModel Select(long ID)
        {
            string sp = "PKG_KNT_MCN_OIL.INV_GEN_ITEM_STK_SELECT";
            try
            {
                var ob = new INV_MCN_OIL_STKModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pINV_GEN_ITEM_STK_ID", Value =0},
        ...
        public long INV_GEN_ITEM_STK_ID { get; set; }
    }
}