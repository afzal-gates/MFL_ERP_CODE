...
namespace ERP.Model
{
    public class INV_STR_TR_ISS_HModel
    {
        ...
        public string Save()
        {
            const string sp = "pkg_inv_str_tr.inv_str_tr_iss_h_insert";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        {
            const string sp = "SP_INV_STR_TR_ISS_H";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<INV_STR_TR_ISS_HModel> SelectAll()
        {
            string sp = "pkg_inv_str_tr.inv_str_tr_iss_h_select";
            try
            {
                var obList = new List<INV_STR_TR_ISS_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pINV_STR_TR_ISS_H_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    INV_STR_TR_ISS_HModel ob = new INV_STR_TR_ISS_HModel();
        ...
        public INV_STR_TR_ISS_HModel Select(Int32? pINV_STR_TR_ISS_H_ID = null)
        {
            string sp = "pkg_inv_str_tr.inv_str_tr_iss_h_select";
            try
            {
                var ob = new INV_STR_TR_ISS_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
        ...
        public List<INV_STR_TR_ISS_HModel> GetInvStrTrIssue(Int64? pINV_STR_TR_REQ_H_ID=null)
        {
            string sp = "pkg_inv_str_tr.inv_str_tr_iss_h_select";
            try
            {
        ...
        public List<INV_STR_TR_ISS_HModel> getStoreIssueListByRefNo(string ISS_REF_NO)
        {
            string sp = "pkg_INV_str_tf.INV_str_tr_iss_h_select";
            try
            {
                var obList = new List<INV_STR_TR_ISS_HModel>();
                OraDatabase db = new OraDatabase();
