...
namespace ERP.Model
{
    public class SCM_STR_RET_DModel
    {
        public Int64 SCM_STR_RET_D_ID { get; set; }
        ...
        public Decimal RET_LOOSE_QTY { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_SCM_STR_RET_D";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pSCM_STR_RET_D_ID", Value = ob.SCM_STR_RET_D_ID},
                     ...
                     new CommandParameter() {ParameterName = "pRET_LOOSE_QTY", Value = ob.RET_LOOSE_QTY},
        ...
        public List<SCM_STR_RET_DModel> SelectAll(Int64? pSCM_STR_RET_H_ID=null)
        {
            string sp = "pkg_scm_str_rcv.scm_str_ret_d_select";
            try
            {
                var obList = new List<SCM_STR_RET_DModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pSCM_STR_RET_H_ID", Value =pSCM_STR_RET_H_ID},
                     new CommandParameter() {ParameterName = "pOption", Value =3001},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    SCM_STR_RET_DModel ob = new SCM_STR_RET_DModel();
                    ob.SCM_STR_RET_D_ID = (dr["SCM_STR_RET_D_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["SCM_STR_RET_D_ID"]);
                    ...
                    ob.RET_LOOSE_QTY = (dr["RET_LOOSE_QTY"] == DBNull.Value) ? 0 : Convert.ToDecimal(dr["RET_LOOSE_QTY"]);
        ...
        public SCM_STR_RET_DModel Select(long ID)
        {
            string sp = "Select_SCM_STR_RET_D";
            try
            {
                var ob = new SCM_STR_RET_DModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pSCM_STR_RET_D_ID", Value =0},
