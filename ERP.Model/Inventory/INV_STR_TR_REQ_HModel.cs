...
namespace ERP.Model
{
    public class INV_STR_TR_REQ_HModel
    {
        ...
        public Int64 LK_STR_TRN_TYP_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "pkg_inv_str_tr.inv_str_tr_req_h_insert";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     ...
                     new CommandParameter() {ParameterName = "pLK_STR_TRN_TYP_ID", Value = ob.LK_STR_TRN_TYP_ID},
        ...
        {
            const string sp = "pkg_inv_str_tr.inv_str_tr_req_h_select";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
        ...
        public List<INV_STR_TR_REQ_HModel> SelectAll(int pageNo, int pageSize, string pSTR_TR_REQ_NO = null, string pSTR_TR_REQ_DT = null, string pCOMP_NAME_EN = null,
        ...
        {
            string sp = "pkg_inv_str_tr.inv_str_tr_req_h_select";
            try
            {
                var obList = new List<INV_STR_TR_REQ_HModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pINV_STR_TR_REQ_H_ID", Value =0},
                ...
                {
                    INV_STR_TR_REQ_HModel ob = new INV_STR_TR_REQ_HModel();
                    ...
                    ob.LK_STR_TRN_TYP_ID = (dr["LK_STR_TRN_TYP_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["LK_STR_TRN_TYP_ID"]);
        ...
        public INV_STR_TR_REQ_HModel Select(Int64? pINV_STR_TR_REQ_H_ID = null)
        {
            string sp = "pkg_inv_str_tr.inv_str_tr_req_h_select";
            try
            {
                var ob = new INV_STR_TR_REQ_HModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
