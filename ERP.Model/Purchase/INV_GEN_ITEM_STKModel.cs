...
namespace ERP.Model
{
    public class INV_GEN_ITEM_STKModel
    {
        public Int64 INV_GEN_ITEM_STK_ID { get; set; }
        ...
        public string Save()
        {
            const string sp = "SP_INV_GEN_ITEM_STK";
            string jsonStr = "{";
            var ob = this;
            var i = 1;
            try
            {
                ...
                {
                     new CommandParameter() {ParameterName = "pINV_GEN_ITEM_STK_ID", Value = ob.INV_GEN_ITEM_STK_ID},
        ...
        public List<INV_GEN_ITEM_STKModel> SelectAll()
        {
            string sp = "PKG_SCM_PURCHASE.INV_GEN_ITEM_STK_SELECT";
            try
            {
                var obList = new List<INV_GEN_ITEM_STKModel>();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
                     new CommandParameter() {ParameterName = "pINV_GEN_ITEM_STK_ID", Value =0},
                     new CommandParameter() {ParameterName = "pOption", Value =3000},
                     new CommandParameter() {ParameterName = "pMsg", Value =500, Direction = ParameterDirection.Output}
                 }, sp);
                foreach (DataRow dr in ds.Tables[0].Rows)
                {
                    INV_GEN_ITEM_STKModel ob = new INV_GEN_ITEM_STKModel();
                    ob.INV_GEN_ITEM_STK_ID = (dr["INV_GEN_ITEM_STK_ID"] == DBNull.Value) ? 0 : Convert.ToInt64(dr["INV_GEN_ITEM_STK_ID"]);
        ...
        public INV_GEN_ITEM_STKModel Select(Int64? pINV_ITEM_ID = null, Int64? pSCM_STORE_ID = null, Int64? pHR_COMPANY_ID = null)
        {
            string sp = "PKG_SCM_PURCHASE.INV_GEN_ITEM_STK_SELECT";
            try
            {
                var ob = new INV_GEN_ITEM_STKModel();
                OraDatabase db = new OraDatabase();
                var ds = db.ExecuteStoredProcedure(new List<CommandParameter>()
                {
        ...
        public INV_GEN_ITEM_STKModel getStockByID(Int64? pINV_ITEM_ID = null, Int64? pSCM_STORE_ID = null, Int64? pHR_COMPANY_ID = null)
        {
            string sp = "PKG_SCM_PURCHASE.INV_GEN_ITEM_STK_SELECT";
            try
            {
