(function () {
    'use strict';
    angular.module('multitex.ie').factory('IeDataService', ['$http', 'exception', '$filter', 'access_token', IeDataService]);

    function IeDataService($http, exception, $filter, access_token) {
        var self = this;
        var urlBase = '/api/ie';
