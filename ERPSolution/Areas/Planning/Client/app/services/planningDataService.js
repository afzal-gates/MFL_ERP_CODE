(function () {
    'use strict';
    angular.module('multitex.planning').factory('PlanningDataService', ['$http', 'exception', '$filter', 'access_token', PlanningDataService]);

    function PlanningDataService($http, exception, $filter, access_token) {
        var self = this;
        var urlBase = '/api/pln';
