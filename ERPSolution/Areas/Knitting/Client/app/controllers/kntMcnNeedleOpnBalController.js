(function () {
    'use strict';
    angular.module('multitex.knitting').controller('KntMcnNeedleOpnBalController', ['$q', 'config', 'KnittingDataService', '$stateParams', '$state', '$scope', 'commonDataService', 'Dialog', '$filter', '$timeout', KntMcnNeedleOpnBalController]);
    function KntMcnNeedleOpnBalController($q, config, KnittingDataService, $stateParams, $state, $scope, commonDataService, Dialog, $filter, $timeout) {
        ...
        vm.getStoreByID = function () {
            ...
            if (vm.form.HR_COMPANY_ID > 0) {
                vm.isExistsOpnBal = 'N';
                KnittingDataService.getDataByFullUrl('/api/common/StoreListByOfcComCatID?pHR_COMPANY_ID=' + (vm.form.HR_COMPANY_ID || 0) + '&pINV_ITEM_CAT_LST=12,128,211').then(function (res) {
        ...
        function GetReqSourceList() {
            return vm.reqSourceList = new kendo.data.DataSource({
                transport: {
                    read: function (e) {
                        KnittingDataService.getDataByFullUrl('/api/common/GetStoreInfo?pINV_ITEM_CAT_LST=128,211,12').then(function (res) {
                            e.success(res);
        ...
        //            transport: {
        //                read: function (e) {
        //                    KnittingDataService.getDataByFullUrl('/api/common/GetStoreInfo?pINV_ITEM_CAT_LST=128').then(function (res) {
            ...
            vm.rcvItemGridDataSource = new kendo.data.DataSource({
                ...
                transport: {
                    read: function (e) {
                        ...
                        var url = '/api/knit/McNeedleOpnBal/GetNeedleOpnBalList';
        ...
        vm.editItemData = function (data) {
            ...
            vm.form.KNT_MCN_NDL_OB_ID = itmData.KNT_MCN_NDL_OB_ID;
        ...
        //    for (var i = 0; i < vm.rcvItemGridDataSource.data().length; i++) {

        //        if (id && vm.rcvItemGridDataSource.data()[i].IS_FINALIZED == 'N')
        //            vm.rcvItemGridDataSource.data()[i].IS_FINALIZED_F = 'Y';
        //        else if (id && vm.rcvItemGridDataSource.data()[i].IS_FINALIZED == 'N')
        //            vm.rcvItemGridDataSource.data()[i].IS_FINALIZED_F = 'N';
        //    }
        //};
