(function () {
    'use strict';
    angular.module('multitex.knitting').controller('YarnIssueReturnController', ['$q', 'config', 'KnittingDataService', '$stateParams', '$state', '$scope', 'commonDataService', 'formData', 'Dialog', 'cur_user_id', YarnIssueReturnController]);
    function YarnIssueReturnController($q, config, KnittingDataService, $stateParams, $state, $scope, commonDataService, formData, Dialog, cur_user_id) {
        ...
        vm.form = formData.KNT_YRN_ISS_RET_H_ID ? formData : { INV_ITEM_CAT_ID: '2', SCM_STORE_ID: '1', ITEM_RET_BY: cur_user_id };
        vm.formItem = {};
        ...
        vm.submitConfirm = function (dataOri) {
            ...
            if (fnValidate() == true) {
                ...
                data["LK_RET_STATUS_ID"] = 494;
                data["RF_ACTN_STATUS_ID"] = 17;
                ...
                return KnittingDataService.saveDataByUrl(data, '/YarnIssueReturn/Save').then(function (res) {
                    ...
                    if (res.success === false) {
                        ...
                        if (id > 0) {
                            ...
                            $state.go('YarnIssueRtn', { pKNT_YRN_ISS_RET_H_ID: 0 });
                        }
                        else {
            ...
            if (fnValidate() == true) {
                ...
                data["XML_RTN_D"] = KnittingDataService.xmlStringShort(vm.ReturnItemList.map(function (o) {
                    return {
                        ...
                        LOOSE_QTY: 0,
                        RET_QTY: o.RET_QTY == null ? 0 : o.RET_QTY,
                        ADV_ADJ_QTY: o.ADV_ADJ_QTY == null ? 0 : o.ADV_ADJ_QTY,                        
                        RCV_QTY: o.RCV_QTY == null ? 0 : o.RCV_QTY
                    }
                }));
                ...
                return KnittingDataService.saveDataByUrl(data, '/YarnIssueReturn/Save').then(function (res) {
                    ...
                    if (res.success === false) {
                        ...
                        if (id > 0) {
                            ...
                            $state.go('YarnIssueRtn', { pKNT_YRN_ISS_RET_H_ID: id });
                        }
                        else {
