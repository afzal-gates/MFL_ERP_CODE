(function () {
    'use strict';
    angular.module('multitex.knitting').controller('KnitMcOilRcvController', ['$q', 'config', 'KnittingDataService', '$stateParams', '$state', '$scope', 'commonDataService', 'formData', 'cur_user_id', '$filter', KnitMcOilRcvController]);
    function KnitMcOilRcvController($q, config, KnittingDataService, $stateParams, $state, $scope, commonDataService, formData, cur_user_id, $filter) {
        ...
        vm.form = formData.KNT_OIL_STR_RCV_H_ID ? formData : { RF_REQ_TYPE_ID: 1, HR_COMPANY_ID: 1, SCM_STORE_ID: 1, PACK_MOU_ID: 10, IS_LC_PNDNG: 'N', INV_ITEM_CAT_ID: '211', ITEM_RCV_BY: cur_user_id, CREATED_BY: cur_user_id, MRR_DT: vm.today };
        vm.formItem = { QTY_MOU_ID: '30', PACK_MOU_ID: 10 };
        ...
        vm.BraOIListBySupplierID = function () {

            return vm.categoryBraOIList = new kendo.data.DataSource({
                transport: {
                    read: function (e) {
                        KnittingDataService.getDataByFullUrl('/api/purchase/SupplierProfile/GetSupplierBraOIList?pSCM_SUPPLIER_ID=' + vm.form.SCM_SUPPLIER_ID).then(function (res) {
        ...
        vm.categoryBraOIList = new kendo.data.DataSource({
            transport: {
                read: function (e) {
                    KnittingDataService.getDataByFullUrl('/api/common/GetItemBraOIList').then(function (res) {
        ...
        function ReceiveItemList() {
            vm.ReceiveItemList = new kendo.data.DataSource({
                transport: {
                    read: function (e) {
                        KnittingDataService.getDataByFullUrl('/api/knit/KnitMcOilRcv/GetKnitMcOilRcvInfoDtlByID?pKNT_OIL_STR_RCV_H_ID=' + ($stateParams.pKNT_OIL_STR_RCV_H_ID || 0)).then(function (res) {
                            e.success(res);
                        });
                    }
                }
        ...
        function ItemList() {
            return vm.DyItemList = new kendo.data.DataSource({
                transport: {
                    read: function (e) {
                        KnittingDataService.getDataByFullUrl('/api/dye/LabdipRecipe/ItemDataListByCatList?pINV_ITEM_CAT_LST=206,207').then(function (res) {
                            e.success(res);
                        });
                    }
                }
        ...
        function GetItemCategoryList() {
            ...
            KnittingDataService.getDataByFullUrl('/api/inv/ItemCategory/SelectAll').then(function (res) {
                var list = _.filter(res, function (o) { return (o.INV_ITEM_CAT_ID === 206 || o.INV_ITEM_CAT_ID === 207) });
        ...
        vm.getItemDataByCategory = function (e) {
            ...
            KnittingDataService.getDataByFullUrl('/api/dye/LabdipRecipe/GetItemListByCatID?pINV_ITEM_CAT_ID=' + (obj.INV_ITEM_CAT_ID || 206)).then(function (res) {
            ...
            if (fnValidateSub() == true) {
                ...
                if (vm.formItem.uid) {
                    ...
                    if (count <= 1) {
                        ...
                        row["KNT_OIL_STR_RCV_H_ID"] = vm.formItem.KNT_OIL_STR_RCV_H_ID;
                        ...
                        vm.formItem = { 'INV_ITEM_ID': ItemID, 'QTY_MOU_ID': '10', 'PACK_MOU_ID': 30 };
        ...
        vm.reset = function () {
            ...
            $state.go($state.current, { pKNT_OIL_STR_RCV_H_ID: 0 });
        ...
        vm.gridOptionsItem = {
            ...
            columns: [
                ...
                { field: "KNT_OIL_STR_RCV_H_ID", hidden: true },
                { field: "KNT_OIL_STR_RCV_D_ID", hidden: true },
        ...
        vm.confirmAll = function (dataOri) {
            ...
            if (fnValidate() == true) {
                ...
                var _invdate = $filter('date')(data.RCV_DOC_DT, 'yyyy-MM-ddTHH:mm:ss');
                data["RCV_DOC_DT"] = _invdate;

                data["XML_RCV_D"] = KnittingDataService.xmlStringShort(vm.ReceiveItemList.data().map(function (o) {
                    return {
                        KNT_OIL_STR_RCV_D_ID: o.KNT_OIL_STR_RCV_D_ID == null ? 0 : o.KNT_OIL_STR_RCV_D_ID,
                        KNT_OIL_STR_RCV_H_ID: o.KNT_OIL_STR_RCV_H_ID == null ? 0 : o.KNT_OIL_STR_RCV_H_ID,
                ...
                var id = vm.form.KNT_OIL_STR_RCV_H_ID

                return KnittingDataService.saveDataByUrl(data, '/KnitMcOilRcv/Save').then(function (res) {
                    ...
                    if (res.success === false) {
                        ...
                        if (parseInt(id) > 0) {
                            ...
                            $state.go($state.current, { pKNT_OIL_STR_RCV_H_ID: id }, { reload: true });
                        }
                        else {
                            config.appToastMsg(res.data.PMSG);
                            if (parseInt(res.data.OPKNT_OIL_STR_RCV_H_ID) > 0) {
                                vm.form.KNT_OIL_STR_RCV_H_ID = res.data.OPKNT_OIL_STR_RCV_H_ID;
                                $state.go($state.current, { pKNT_OIL_STR_RCV_H_ID: res.data.OPKNT_OIL_STR_RCV_H_ID }, { reload: true });
                            }
                        }
