(function () {
    'use strict';
    angular.module('multitex.knitting').controller('KntDailyProdListController', ['$q', 'config', 'KnittingDataService', '$stateParams', '$state', '$scope', 'Dialog', KntDailyProdListController]);
    function KntDailyProdListController($q, config, KnittingDataService, $stateParams, $state, $scope, Dialog) {
        ...
        vm.dailyProdOpt = {
            ...
            columns: [
                ...
                //{ field: "FAB_TYPE_SNAME", title: "Fab.Type", width: "100px" },
                ...
                { field: "MC_DIA", title: "MC DIA", width: "70px" },
                { field: "MC_GG", title: "MC GG", width: "70px" },
                { field: "KNT_YRN_LOT_LST", title: "Yarn Detail", width: "200px" },
                {                    
                    title: "Shift wise Produced Qty (Kg)",
                    headerAttributes: {
                    ...
                    columns: [
                        {
                            field: "A_SHIFT_QTY", title: "A-Shift", width: "80px"//,
                            //footerTemplate: "#=sum#"
                        },
                        {
                            field: "B_SHIFT_QTY", title: "B-Shift", width: "80px"//,
                            //footerTemplate: "#=sum#"
                        },
                        {
                            field: "C_SHIFT_QTY", title: "C-Shift", width: "80px"//,
                            //footerTemplate: "#=sum#"
                        },
                        {
                            field: "TOT_QTY", title: "Total", width: "80px"//,
                            //footerTemplate: "#=sum#"
                        }
                    ]
                },
                ...
                {
                    field: "CUMULA_QTY", title: "Cumul. Qty",
                    headerAttributes: {
                        style: "text-align: center; font-weight: bold; white-space: normal"
                    },
                    width: "80px"//,
                ...
                {
                    field: "BAL_QTY", title: "Balance Qty",
                    headerAttributes: {
                        style: "text-align: center; font-weight: bold; white-space: normal"
                    },
                    width: "80px"//,
            ...
            vm.DailyProdDs = new kendo.data.DataSource({
                ...
                transport: {
                    read: function (e) {
                        var webapi = new kendo.data.transports.webapi({});
                        var params = webapi.parameterMap(e.data);
                        var url = '/api/knit/KnitCommon/GetDailyProdList';
