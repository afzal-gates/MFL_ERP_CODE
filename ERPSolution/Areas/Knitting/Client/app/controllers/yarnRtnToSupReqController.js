(function () {
    'use strict';
    angular.module('multitex.knitting').controller('YarnRtnToSupReqController', ['$q', 'config', 'KnittingDataService', '$stateParams', '$state', '$scope', 'commonDataService', 'formData', 'Dialog', 'cur_user_id', '$filter', '$http', YarnRtnToSupReqController]);
    function YarnRtnToSupReqController($q, config, KnittingDataService, $stateParams, $state, $scope, commonDataService, formData, Dialog, cur_user_id, $filter, $http) {
        ...
        vm.form = formData.KNT_YRN_STR_RPL_REQ_H_ID ? formData : { INV_ITEM_CAT_ID: '2', HR_COMPANY_ID: 1, SCM_STORE_ID: 1, RF_REQ_TYPE_ID: 40, STR_REQ_TO: 152, STR_REQ_BY: cur_user_id, STR_REQ_DT: vm.today, RF_ACTN_VIEW: 0 };
        vm.formItem = {};

        activate();
        vm.showSplash = true;
        function activate() {
            var promise = [ReturnList(), ReceiveItemList(), getCurrencyList(), getUserData(), GetItemCategoryList(), ItemList(), YarnLotList(),
                GetReqTypeList(), GetReqStoreList(), GetCompanyList(), GetStatusList(), GetYarnColorGroupList(), GetMOUList(), GetSupplierList(),
                GetReturnTypeList(), getLCList()];
        ...
        function getLCList() {
            return vm.lcList = {
                ...
                dataSource: {
                    transport: {
                        read: function (e) {
                            KnittingDataService.getDataByFullUrl('/api/Knit/YarnReturnToSupplier/GetReplacementReqDtlByID?pKNT_YRN_STR_RPL_REQ_H_ID=' + ($stateParams.pKNT_YRN_STR_RPL_REQ_H_ID || 0)).then(function (res) {
                                console.log(res);
        ...
        function ReturnList() {
            return vm.ReturnItemList = new kendo.data.DataSource({
                ...
                transport: {
                    read: function (e) {
                        KnittingDataService.getDataByFullUrl('/api/Knit/YarnReturnToSupplier/GetReplacementReqDtlByID?pKNT_YRN_STR_RPL_REQ_H_ID=' + (formData.PARENT_ID || $stateParams.pKNT_YRN_STR_RPL_REQ_H_ID || 0)).then(function (res) {
        ...
        vm.checkReturnQty = function (item) {
            if (item.STOCK_QTY < item.REQ_RTN_QTY)
                item.REQ_RTN_QTY = '';
        };
        ...
        vm.addToRcvGrid = function (isValid) {
            ...
            if (fnValidateSub2() == true) {
                ...
                vm.formRcvItem.CM_IMP_LC_H_ID = vm.form.CM_IMP_LC_H_ID;
                ...
                if (vm.formRcvItem.uid) {
                    ...
                    if (count <= 1) {
                        ...
                        row["CM_IMP_LC_H_ID"] = vm.formRcvItem.CM_IMP_LC_H_ID;
        ...
        function ReceiveItemList() {
            vm.ReceiveItemList = new kendo.data.DataSource({
                transport: {
                    read: function (e) {
                        KnittingDataService.getDataByFullUrl('/api/Knit/YarnReturnToSupplier/GetReplacementReceiveDtlByID?pKNT_YRN_STR_RPL_REQ_H_ID=' + ($stateParams.pKNT_YRN_STR_RPL_REQ_H_ID || 0)).then(function (res) {
                            e.success(res);
                        });
                    }
                }
        ...
        vm.reset = function () {
            ...
            $state.go('YarnIssueReq', { pKNT_YRN_STR_RPL_REQ_H_ID: 0 });
                    ...
                    transport: {
                        read: function (e) {
                            KnittingDataService.getDataByFullUrl('/api/common/GetReqType').then(function (res) {
                                var list = _.filter(res, function (o) { return o.RF_REQ_TYPE_ID == 40 });
                                e.success(list);
                            });
                        }
                    }
        ...
        vm.gridOptionsRtnItem = {
            ...
            columns: [
                ...
                { field: "REQ_RTN_QTY", title: "Return Qty.", type: "string", width: "7%" },
                {
                    title: "",
        ...
        vm.submitConfirm = function (dataOri) {
            ...
            if (fnValidate() == true) {
                ...
                data["XML_REQ_D"] = KnittingDataService.xmlStringShort(vm.ReturnItemList.data().map(function (o) {
                    return {
                        KNT_YRN_STR_RPL_REQ_D_ID: o.KNT_YRN_STR_RPL_REQ_D_ID == null ? 0 : o.KNT_YRN_STR_RPL_REQ_D_ID,
                        KNT_YRN_STR_RPL_REQ_H_ID: o.KNT_YRN_STR_RPL_REQ_H_ID == null ? 0 : o.KNT_YRN_STR_RPL_REQ_H_ID,
                        ...
                        REQ_RTN_QTY: o.REQ_RTN_QTY == null ? o.ISSUE_QTY : o.REQ_RTN_QTY,
                        QTY_MOU_ID: 3,
                        ACT_ISS_QTY: 0,
                ...
                var id = vm.form.KNT_YRN_STR_RPL_REQ_H_ID

                return KnittingDataService.saveDataByUrl(data, '/YarnReturnToSupplier/SaveReq').then(function (res) {
                    ...
                    if (res.success === false) {
                        ...
                        if (parseInt(res.data.OPKNT_YRN_STR_RPL_REQ_H_ID) > 0) {
                            vm.form.KNT_YRN_STR_RPL_REQ_H_ID = res.data.OPKNT_YRN_STR_RPL_REQ_H_ID;
                            $state.go($state.current, { pKNT_YRN_STR_RPL_REQ_H_ID: res.data.OPKNT_YRN_STR_RPL_REQ_H_ID }, { reload: true });
                        }
        ...
        vm.sendMail = function () {
            ...
            $http({
                url: '/Knitting/Knit/FireYarnRtnMail',
                method: 'get',
                params: { pKNT_YRN_STR_RPL_REQ_H_ID: (vm.form.KNT_YRN_STR_RPL_REQ_H_ID || 0) }
            });
        }
