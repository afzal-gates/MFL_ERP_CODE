(function () {
    'use strict';
    angular.module('multitex.knitting').controller('JobCardDashboardModalController', ['$q', 'config', 'KnittingDataService', 'Params', '$scope', '$modalInstance', '$modal', JobCardDashboardModalController]);
    function JobCardDashboardModalController($q, config, KnittingDataService, Params, $scope, $modalInstance, $modal) {
        ...
        function activate() {
            var promise = [getSelectMonth(0, 0),
                           getStyleExtList(null, (Params.pRF_FAB_PROD_CAT_ID||Params.DEFAULT_CAT_ID), null, null),
                           getFabOederByOh(null, (Params.pRF_FAB_PROD_CAT_ID || Params.DEFAULT_CAT_ID), null, null, ''),
                           /*showGrid(0, (Params.pMC_FAB_PROD_ORD_H_ID || 0), (Params.pRF_FAB_PROD_CAT_ID || Params.DEFAULT_CAT_ID), null, (Params.LK_COL_TYPE_ID_LST || ''))*/];
        ...
        $scope.search = {
            MC_BYR_ACC_ID: 0,
            RF_FAB_PROD_CAT_ID: (Params.pRF_FAB_PROD_CAT_ID || Params.DEFAULT_CAT_ID),
        ...
        function newKnitPlan(dataItem) {
            var modalInstance = $modal.open({
                animation: true,
                templateUrl: (dataItem.LK_COL_TYPE_ID == 360 ? '/Knitting/Knit/_KnitPlanYdModal' : '/Knitting/Knit/_KnitPlanModal'),
                controller: (dataItem.LK_COL_TYPE_ID == 360 ? 'KnitPlanYdController as vm' : 'KnitPlanController as vm'),
                resolve: {
