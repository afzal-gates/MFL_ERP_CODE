(function () {
    'use strict';
    angular.module('multitex.garments').factory('GarmentsDataService', ['$http', 'exception', '$filter', 'access_token', GarmentsDataService]);

    function GarmentsDataService($http, exception, $filter, access_token) {
        var self = this;
        var urlBase = '/api/gmt';
