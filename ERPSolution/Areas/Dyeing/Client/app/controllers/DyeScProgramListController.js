...
(function () {
    'use strict';
    angular.module('multitex.dyeing').controller('DyeScProgramListController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$state', '$rootScope', '$scope', 'Hub', 'cur_user_id', '$modal', DyeScProgramListController]);
    function DyeScProgramListController($q, config, DyeingDataService, $stateParams, $state, $rootScope, $scope, Hub, cur_user_id, $modal) {
