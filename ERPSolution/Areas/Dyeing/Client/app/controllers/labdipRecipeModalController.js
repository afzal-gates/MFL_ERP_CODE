(function () {
    'use strict';
    angular.module('multitex.dyeing').controller('LabdipRecipeModalController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$state', '$scope', 'Dialog', 'DateShareService', 'formData', '$modal', '$modalInstance', LabdipRecipeModalController]);
    function LabdipRecipeModalController($q, config, DyeingDataService, $stateParams, $state, $scope, Dialog, DateShareService, formData, $modal, $modalInstance) {
