...
(function () {
    'use strict';
    angular.module('multitex.dyeing').controller('DyeBatchProgram1ModalController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$modalInstance', '$scope', 'formData', 'McDataDs', DyeBatchProgram1ModalController]);
    function DyeBatchProgram1ModalController($q, config, DyeingDataService, $stateParams, $modalInstance, $scope, formData, McDataDs) {
