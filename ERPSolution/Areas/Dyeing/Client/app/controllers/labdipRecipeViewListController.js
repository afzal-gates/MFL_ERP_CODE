(function () {
    'use strict';
    angular.module('multitex.mrc').controller('LabdipRecipeViewListController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$state', '$scope', '$timeout', 'DateShareService', '$sessionStorage', LabdipRecipeViewListController]);
    function LabdipRecipeViewListController($q, config, DyeingDataService, $stateParams, $state, $scope, $timeout, DateShareService, $sessionStorage) {
        ...
        vm.gridOptions = {
            ...
            columns: [
...

                {
                    title: "Action",
                    template: function () {
                        return "</a><a ui-sref='LabdipRecipeView({pMC_LD_RECIPE_H_ID:dataItem.MC_LD_RECIPE_H_ID, pRECHECK_ID:0})' class='btn btn-xs blue'><i class='fa fa-edit'> View</i></a></a>";
                    },
                    width: "15%"
                }
            ]
