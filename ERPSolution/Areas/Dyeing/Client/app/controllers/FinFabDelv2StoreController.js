(function () {
    'use strict';
    angular.module('multitex.dyeing').controller('FinFabDelv2StoreController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$state', '$scope', 'commonDataService', 'cur_user_id', '$filter', 'Dialog', FinFabDelv2StoreController]);
    function FinFabDelv2StoreController($q, config, DyeingDataService, $stateParams, $state, $scope, commonDataService, cur_user_id, $filter, Dialog) {
        ...
        vm.gridOptions = {
            ...
            columns: [
                ...
                { field: "DF_DT", title: "DF Date", type: "date", template: "#= kendo.toString(kendo.parseDate(DF_DT,'yyyy-MM-dd'),'dd-MMM-yyyy') #", width: "10%" },
                { field: "BP_DT", title: "Dye Date", type: "date", template: "#= kendo.toString(kendo.parseDate(BP_DT,'yyyy-MM-dd'),'dd-MMM-yyyy') #", width: "10%" },
                { field: "BYR_ACC_GRP_NAME_EN", title: "Buyer", type: "string", editable: false, width: "10%"},
                { field: "STYLE_NO", title: "Style", type: "string", editable: false, width: "8%"},
                { field: "ORDER_NO", title: "Order", type: "string", editable: false, width: "20%" },
                { field: "COLOR_NAME_EN", title: "Color", type: "string", editable: false, width: "5%" },
                
                { field: "DYE_LOT_NO", title: "Lot", type: "string", editable: false, width: "4%" },
                { field: "FAB_TYPE_SNAME", title: "Fabric Type", type: "string", editable: false, width: "6%", },
                { field: "RQD_GSM", title: "GSM", type: "string", editable: false, width: "5%", },
                { field: "LOT_QTY", title: "Lot Qty.", type: "decimal", editable: false, width: "6%" },
                { field: "FINIS_QTY", title: "Finish Qty", type: "decimal", editable: false, width: "6%" },
                { field: "ACT_NO_ROLL", title: "Loss(%)", type: "decimal", editable: true, width: "5%" },
                { field: "FB_DFCT_TYPE_NAME", title: "Status", type: "string", editable: false, width: "10%" },
                //{ field: "IS_SELECT", title: "Select", width: "5%", editable: false, template: "<input type='checkbox' ng-model='dataItem.IS_SELECT' />" },
                //DF_DT, BATCH_DT, BYR_ACC_GRP_NAME_EN, STYLE_NO, ORDER_NO, COLOR_NAME_EN, DYE_LOT_NO, FAB_TYPE_SNAME, RQD_GSM, LOT_QTY, FINIS_QTY, POL, DFCT_TYPE_LST
            ]
