...
(function () {
    'use strict';
    angular.module('multitex.dyeing').controller('BatchAtFabricStoreController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$state', '$scope', 'commonDataService', 'cur_user_id', '$filter', 'Dialog', BatchAtFabricStoreController]);
    function BatchAtFabricStoreController($q, config, DyeingDataService, $stateParams, $state, $scope, commonDataService, cur_user_id, $filter, Dialog) {
        ...
        vm.form = { RECEIVE_DT: vm.today, SCM_STORE_ID: 25 };

        activate()
        vm.showSplash = true;
        function activate() {
            var promise = [GetReqSourceList(), getUserData(), getPendingSubLot()];
        ...
        //    DyeingDataService.getDataByFullUrl('/api/dye/DfFinishFabric/SelectPendingLotRcv2CutStore').then(function (res) {
        //        vm.QcRollLotList = res;
        //    });
        //}

        vm.SearchPendingSubLot = function () {
            DyeingDataService.getDataByFullUrl('/api/dye/DfFinishFabric/SelectPendingLotRcv2CutStore?pMC_BYR_ACC_GRP_ID=' + (vm.form.MC_BYR_ACC_GRP_ID || null) + '&pMC_FAB_PROD_ORD_H_ID=' + (vm.form.MC_FAB_PROD_ORD_H_ID || null) + '&pRF_FAB_PROD_CAT_ID=' + (vm.form.RF_FAB_PROD_CAT_ID || null) + '&pMONTHOF=' + (vm.form.MONTHOF || '')).then(function (res) {
                vm.QcRollLotList = res;
            });
        }
        ...
        vm.gridOptions = {
            ...
            columns: [
                ...
                { field: "SUB_LOT_NO", title: "Lot No", type: "string", editable: false, width: "5%" },
                { field: "YARN_SPEC", title: "Fabric Details", type: "string", editable: false, width: "30%", },
                { field: "LOT_QTY", title: "Grey Qty.", type: "decimal", editable: false, width: "10%" },
        ...
        vm.submitAll = function (dataOri) {
            ...
            if (fnValidate() == true) {
                ...
                data["XML_LOT"] = DyeingDataService.xmlStringShort(iList.map(function (o) {
                    return {
                        DF_BT_MVM_CUT_STR_H_ID: o.DF_BT_MVM_CUT_STR_H_ID == null ? 0 : o.DF_BT_MVM_CUT_STR_H_ID,
                        DF_BT_MVM_FAB_STR_H_ID: o.DF_BT_MVM_FAB_STR_H_ID == null ? 0 : o.DF_BT_MVM_FAB_STR_H_ID,
                        SCM_STORE_ID: vm.form.SCM_STORE_ID,
                        DF_BT_SUB_LOT_ID: o.DF_BT_SUB_LOT_ID == null ? 0 : o.DF_BT_SUB_LOT_ID,
                        RECEIVE_DT: _isudate,
                        ISSUE_DT: _isudate,
                        RCV_NO_ROLL: o.ACT_NO_ROLL == null ? 0 : o.ACT_NO_ROLL,
                        RCV_FAB_QTY: o.ACT_FINIS_QTY == null ? 0 : o.ACT_FINIS_QTY,
                        REMARKS: o.REMARKS,
                        IS_FINALIZED: 'Y'
                    }
                }));

                return DyeingDataService.saveDataByUrl(data, '/DfFinishFabric/SaveCutStore').then(function (res) {
