...
(function () {
    'use strict';
    angular.module('multitex.dyeing').controller('DyeingScProgramController', ['$q', 'config', 'DyeingDataService', '$stateParams', '$state', '$scope', 'formData', 'commonDataService', 'cur_user_id', 'Dialog', '$filter', DyeingScProgramController]);
    function DyeingScProgramController($q, config, DyeingDataService, $stateParams, $state, $scope, formData, commonDataService, cur_user_id, Dialog, $filter) {
