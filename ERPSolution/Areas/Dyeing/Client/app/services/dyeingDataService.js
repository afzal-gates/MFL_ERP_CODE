(function () {
    'use strict';
    angular.module('multitex.dyeing').factory('DyeingDataService', ['$http', 'exception', '$filter', 'access_token', '$q', DyeingDataService]);

    function DyeingDataService($http, exception, $filter, access_token, $q) {
        var self = this;
        var urlBase = '/api/dye';
