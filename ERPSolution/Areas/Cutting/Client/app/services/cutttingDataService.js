(function () {
    'use strict';
    angular.module('multitex.cutting').factory('CuttingDataService', ['$http', 'exception', '$filter', 'access_token', CuttingDataService]);

    function CuttingDataService($http, exception, $filter, access_token) {
        var self = this;
        var urlBase = '/api/Cutting';
