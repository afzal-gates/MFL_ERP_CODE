(function () {
    'use strict';
    angular.module('multitex.purchase').factory('PurchaseDataService', ['$http', 'exception', '$filter', 'x2js', 'access_token', PurchaseDataService]);

    function PurchaseDataService($http, exception, $filter, x2js, access_token) {
        var self = this;
