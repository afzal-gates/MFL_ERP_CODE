(function () {
    ...
    angular.module('multitex.admin').controller('GradeController', ['logger', 'config', '$q', '$scope', '$http', GradeController]);

    function GradeController(logger, config, $q, $scope, $http) {
