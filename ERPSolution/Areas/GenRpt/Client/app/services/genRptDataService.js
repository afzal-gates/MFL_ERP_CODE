(function () {
    'use strict';
    angular.module('multitex.cmr').factory('GenRptDataService', ['$http', 'exception', '$filter', 'access_token', '$q', GenRptDataService]);

    function GenRptDataService($http, exception, $filter, access_token, $q) {
        var self = this;
        var urlBase = '/api/genRpt';
        ...
        self.getDataByFullUrlWait = function (url) {
