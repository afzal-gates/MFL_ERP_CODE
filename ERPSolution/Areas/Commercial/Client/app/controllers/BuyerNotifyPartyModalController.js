(function () {
    'use strict';
    angular.module('multitex.cmr').controller('BuyerNotifyPartyModalController', ['$q', 'config', 'CmrDataService', '$stateParams', '$state', '$rootScope', '$scope', 'cur_user_id', '$filter', 'Dialog', 'formData', '$modalInstance', BuyerNotifyPartyModalController]);
    function BuyerNotifyPartyModalController($q, config, CmrDataService, $stateParams, $state, $rootScope, $scope, cur_user_id, $filter, Dialog, formData, $modalInstance) {
        ...
        vm.cancel = function () {
            $modalInstance.close(vm.NotifyList);
        }
