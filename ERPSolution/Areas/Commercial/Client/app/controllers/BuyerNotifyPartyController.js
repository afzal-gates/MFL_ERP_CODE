(function () {
    'use strict';
    angular.module('multitex.cmr').controller('BuyerNotifyPartyController', ['$q', 'config', 'CmrDataService', '$stateParams', '$state', '$rootScope', '$scope', 'cur_user_id', '$filter', 'Dialog', BuyerNotifyPartyController]);
    function BuyerNotifyPartyController($q, config, CmrDataService, $stateParams, $state, $rootScope, $scope, cur_user_id, $filter, Dialog) {
