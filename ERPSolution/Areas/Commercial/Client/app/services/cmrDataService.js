(function () {
    'use strict';
    angular.module('multitex.cmr').factory('CmrDataService', ['$http', 'exception', '$filter', 'access_token', '$q', CmrDataService]);

    function CmrDataService($http, exception, $filter, access_token, $q) {
        var self = this;
        var urlBase = '/api/cmr';
